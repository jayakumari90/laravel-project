                ...
                <div class="row">
                    ...
                    <div id="Billing" class="w3-container w3-display-container city" style="display:none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="shipping_address"><small class="req text-danger">* </small>Shipping Address</label><label style="float:right"> Same as Customer Info</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="billing_zipcode" id="billing_zipcode">
